...
describe('query', function () {
  describe('HashQuery', () => {
    it('should new CompositeQuery', () => {
      ...
      const query = new Query<Schema, Schema['hsk']>(log, 'hsk', 'hello')
  ...
  describe('CompositeQuery', () => {
    it('should sort descend', async done => {
      ...
      const query = new Query<Schema, Schema['hsk'], Schema['rgk']>(log, 'hsk', 'hello')
    ...
    describe('.range', function () {
      describe('.()', function () {
        ...
        it('.beginsWith() should includes RangeKey condition in KeyConditionExpression', async done => {
          ...
          const query = new Query<StringSchema, StringSchema['hsk'], StringSchema['rgk']>(log, 'hsk', 'hello')
          const actual = await query
            .range('rgk')
            .beginsWith('123')
            .out()
